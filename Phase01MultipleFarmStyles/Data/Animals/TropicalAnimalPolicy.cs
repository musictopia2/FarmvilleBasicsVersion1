...
public class TropicalAnimalPolicy : IAnimalPolicy
{
    private readonly int _maximumUnlocks = 2;
    private readonly int _maximumLocks = 2;
    ...
    {
        if (animalName == TropicalAnimalListClass.Dolphin)
        {
            return Task.FromResult(true); //dolphins allow increasing options
        }
