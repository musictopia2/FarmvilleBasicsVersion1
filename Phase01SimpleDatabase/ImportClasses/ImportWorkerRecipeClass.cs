...
internal static class ImportWorkerRecipeClass
{
    ...
    private static BasicList<WorkerRecipeDocument> GetCountry()
    {
        ...
        worker = new()
        {
            ...
            Details = "Increased Chance of Chives",
            Theme = theme
        };
        benefit = new()
        {
        ...
        worker = new()
        {
            ...
            Details = "Gets 1 extra blackberry at grandmas glade.",
            Theme = theme
        ...
        worker = new()
        {
            ...
            Details = "Gets 1 extra trout at pond.",
            Theme = theme
        };
        benefit = new()
        {
        ...
        benefit = new()
        {
            Worksite = CountryWorksiteListClass.Cave,
