...
public class GameState : IGameTimer
{
    ...
    readonly QuestRegistry _questRegistry;
    ...
    {
        _inventory = new();
        _inventory.Add(EnumItemType.Wheat, 6);
        _inventory.Add(EnumItemType.Corn, 6);
        _inventory.Add(EnumItemType.Shrimp, 6);
        _inventory.Add(EnumItemType.Honey, 6);
    ...
    public bool CanCompleteQuest(QuestRecipe recipe) => _inventory.Has(recipe.Item, recipe.Required);
    public void CompleteQuest(QuestRecipe recipe)
    {
        ...
        _inventory.Consume(recipe.Item, recipe.Required);
        StateChanged?.Invoke();
