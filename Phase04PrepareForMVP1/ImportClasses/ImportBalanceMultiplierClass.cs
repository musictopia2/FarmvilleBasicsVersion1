...
public static class ImportBalanceMultiplierClass
{
    public static async Task ImportBalanceMultiplierAsync()
    {
        ...
        list.Add(CreateFarm(PlayerList.Player1, FarmThemeList.Country, ProfileIdList.Production, 0.5, treeOverride: 0.25, worksiteOverride: 0.3333));
        list.Add(CreateFarm(PlayerList.Player2, FarmThemeList.Country, ProfileIdList.Production, 0.5, treeOverride: 0.25,  worksiteOverride: 0.3333));
        list.Add(CreateFarm(PlayerList.Player1, FarmThemeList.Tropical, ProfileIdList.Production, 0.5, treeOverride: 0.25, worksiteOverride: 0.33333));
        list.Add(CreateFarm(PlayerList.Player2, FarmThemeList.Tropical, ProfileIdList.Production, 0.5, treeOverride: 0.25, worksiteOverride: 0.33333));
