...
public static class ImportInventoryClass
{
    public static async Task ImportBeginningInventoryAmountsAsync()
    {
        ...
        list.Add(Create(PlayerList.Player1, FarmThemeList.Country, ProfileIdList.Production, GetCountryProduction()));
        list.Add(Create(PlayerList.Player2, FarmThemeList.Country, ProfileIdList.Production, GetCountryProduction()));
        list.Add(Create(PlayerList.Player1, FarmThemeList.Tropical, ProfileIdList.Production, GetTropicalProduction()));
        list.Add(Create(PlayerList.Player2, FarmThemeList.Tropical, ProfileIdList.Production, GetTropicalProduction()));
